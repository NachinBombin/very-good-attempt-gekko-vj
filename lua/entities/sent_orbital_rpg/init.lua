...
-- Configuration
-- =========================================================================
local SPEED          = 1900    -- units/s 
local ORBIT_RADIUS_A = 41     -- ellipse semi-major axis  (side-to-side)  [tightened from 48]
local ORBIT_RADIUS_B = 32     -- ellipse semi-minor axis  (up-down)        [tightened from 28]
local ORBIT_SPEED    = 4.5    -- radians/s  (how fast it circles)
local LIFETIME       = 20     -- seconds before self-removal
local DAMAGE         = 80
local BLAST_RADIUS   = 200

local FLAME_LOOP_SND = "nikita/flame_loop.wav"
local FLAME_SND_LEVEL = 92  -- SNDLVL_NORM

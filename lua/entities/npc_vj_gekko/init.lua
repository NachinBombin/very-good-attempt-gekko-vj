...
local function SpawnCartridge(pos, ang, scale)
    ...
    -- APS SAFETY: tag shell so aps_system.lua skips it
    -- unconditionally. prop_physics is no longer a blanket
    -- class whitelist, so each casing needs this flag.
    shell._gekkoOwnedGib = true

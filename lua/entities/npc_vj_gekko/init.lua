...
-- ============================================================
-- JUICY BLEEDING INTEGRATION: Include extensions for bone detection
-- ============================================================
if SERVER then
...
-- ============================================================
-- JUICY BLEEDING INTEGRATION: Core spawning function
-- Byte-for-byte copy of OFBleeding_DO from of_simple_bleeding.lua
-- ============================================================
if SERVER then
...
-- ============================================================
-- CORE: Spawn bleeding particle effect (BYTE-FOR-BYTE IDENTICAL)
-- ============================================================
...
function ENT:OnTakeDamage(dmginfo)
 ...
 -- Signal cl_init to fire blood stream effect (ORIGINAL)
 if dmginfo:IsBulletDamage() then
  GekkoSignalBloodHit(self, hitPos, hitDir)
 end

 -- ============================================================
 -- NEW BLEEDING TYPE: Juicy Bleeding Effect (NPC-owned only)
 -- Triggered on bullet damage, uses GetAnimBone for precise attachment
 -- ============================================================
 if SERVER and dmginfo:IsBulletDamage() and GekkoTriggerJuicyBleed then

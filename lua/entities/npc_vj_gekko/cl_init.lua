...
local function GekkoApplyGroundedPose(ent)
    ...
    local lHip = ent:LookupBone("b_l_hippiston1")
    if lHip and lHip >= 0 then
        ent:ManipulateBoneAngles(lHip, GND_L_HIP_ANG, false)
    end

    local rHip = ent:LookupBone("b_r_hippiston1")
    if rHip and rHip >= 0 then
        ent:ManipulateBoneAngles(rHip, GND_R_HIP_ANG, false)
    end
end

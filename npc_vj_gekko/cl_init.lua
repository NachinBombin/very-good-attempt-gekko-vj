...
--
--  Driven by NWInt "GekkoKickPulse" incremented every walk-crush.
--  Each pulse extends the hold window by KICK_WINDOW seconds.
--  Bone is explicitly zeroed when the window expires.
-- ============================================================
